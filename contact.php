    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!$conn){
        ...
        if($result){
          ...
          <strong>Success!</strong> Your entry has been submitted successfully. Thank you ' . $name . ' for contacting us.
          ...
          <strong>Error!</strong> We are facing some technical problems in sending your message. We will fix this problem. We are sorry for this.
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>';
